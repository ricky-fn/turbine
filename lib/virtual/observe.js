        ...
        value: function loopObj(obj, res, observer) {
            ...
            if (isObservered(obj)) {
                ...
                keys.forEach(function (prop, index) {
                    // loop the reactive data to find deleted subValues
                    ...
                    Object.defineProperty(obj, prop, {
                        get: function get() {
                            ...
                            if (watcher) {
                                ...
                                var depTarget = obj instanceof Array ? observer.dep : dep; // if the val's parent value is not an Array set the dep target as private dep
                        ...
                        set: function set(newVal) {
                            ...
                            var depTarget = res instanceof Array ? observer.dep : dep; // if the val's parent value is not an Array set the dep target as private dep
...
var observer = function () {
    ...
    _createClass(observer, [{
        key: 'update',
        value: function update(key, newVal, react) {
